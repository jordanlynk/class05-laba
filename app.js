...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var sumAndMultiplyArr = [];

    var aAndB  = sum(a, b)[0];
    var allSum = sum(aAndB, c)[0];
    sumAndMultiplyArr[0] = allSum;

    var aMultB = multiply(a, b)[0];
    var finProduct = multiply(aMultB, c)[0];
    sumAndMultiplyArr[1] = finProduct;

    sumAndMultiplyArr[2] = + a + ' and ' + b + ' and ' + c + ' sum to ' + allSum + '.';
    sumAndMultiplyArr[3] = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + finProduct + '.';
